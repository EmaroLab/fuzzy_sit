...
import it.emarolab.runnableSITutility.sceneRecustructor.SceneParticle;
...
public class SITABox
    ...
    private Individual addSceneIndividual( SigmaCounters sigma)
        ...
        for ( SigmaCounters.Sigma cnt : sigma.getCounters()) {
            Concept restriction = abox.addDatatypeRestriction( Concept.EXACT_VALUE, cnt.getRoundedCount(), cnt.getRole());
