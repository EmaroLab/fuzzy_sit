package it.emarolab.runnableSITutility.sceneRecustructor;
 ...
 * </small></div>
 *
 * @see it.emarolab.runnableSITutility.sceneRecustructor.GuidedCarlo
 */
abstract public class MonteCarloInterface
        extends Thread
     ...
     */
    public MonteCarloInterface(SITTBox tbox, String toGenerateName, int particlesNumber) {
    ...
    protected abstract class CarloListener
            extends Thread
            implements FuzzySITBase{
    ...
    protected class CsvCarloListener
