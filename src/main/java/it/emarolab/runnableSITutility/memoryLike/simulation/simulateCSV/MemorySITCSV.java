...
import it.emarolab.runnableSITutility.memoryLike.simulation.MemoryExample;
...
public class MemorySITCSV {
    ...
    public static void main(String[] args) {
        MemoryExample memory = new MemoryExample(FuzzySITBase.RESOURCES_PATH + "ontologies/table_assembling_memory_example.fuzzydl", false);
